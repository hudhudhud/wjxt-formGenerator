        ...
        return (
            <el-col span={scheme.span}>
                <el-row gutter={scheme.gutter}>
                    <p class="contain-wrapper-title"><span style='color:red'>*</span>{config.label}</p>
                    <div class="contain-wrapper-content">
                        {child}
                    </div>
                </el-row>
            </el-col>
...
function renderChildren(h, scheme,isCollpase) {
    ...
    methods: {
        initLabelFormData(componentList, formData) {
            ...
            componentList.forEach(cur => {
                ...
                if (cur.children) this.initLabelFormData(cur.children, formData)
        ...
        initFormData(componentList, formData) {
            ...
            componentList.forEach(cur => {
                ...
                if(cur.enableFold&&Array.isArray(cur.children))this.initFormData(cur.children, formData)
        ...
        buildRules(componentList, rules) {
            componentList.forEach(cur => {
                ...
                if(cur.enableFold&&Array.isArray(cur.children))this.buildRules(cur.children, rules)
...
.el-collapse-item__header .el-col,
