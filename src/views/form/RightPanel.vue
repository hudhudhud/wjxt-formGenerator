        ...
        <div class="field-box">
            <el-scrollbar class="right-scrollbar">
                ...
                <el-form v-show="currentTab==='field' && showField" size="small" label-width="90px">
                    ...
                    <el-form-item  label="是否为折叠" v-if="activeData.__config__.layout!=='rowFormItem'">
                      <el-switch v-model="activeData.enableFold" @change="enableFoldChange"/>
                    </el-form-item>
                    <el-form-item  label="管理侧显示" v-if="[1,2,7].indexOf(activeData.typeId)>-1">
                      <el-switch v-model="activeData.enableShow"/>
                    </el-form-item>
                    <el-form-item v-if="activeData.placeholder!==undefined&&activeData.__config__.layout!=='rowFormItem'" label="占位提示">
                    ...
                    <el-form-item v-if="activeData.__config__.span!==undefined&&activeData.__config__.layout!=='rowFormItem'" label="表单栅格">
                    ...
                    <el-form-item v-if="activeData.__vModel__!==undefined&&activeData.__config__.layout!=='rowFormItem'" label="默认值">
                        <el-input
            ...
            && activeData.__config__.labelWidth !== undefined" label="显示标签"
              ...
              (activeData.__config__.optionType === 'button' ||
                ...
                activeData.__config__.tag === 'el-button')"
                    ...
                    <el-form-item v-if="activeData.__config__.required !== undefined&&activeData.__config__.layout!=='rowFormItem'" label="是否必填">
...
export default {
    ...
    methods: {
        ...
        enableFoldChange(val){
            if(!val&&this.activeData.children&&this.activeData.children.length){
                this.$confirm('确认关闭折叠，该操作将删除折叠项下所有组件？', '提示', {
                confirmButtonText: '确定',
                cancelButtonText: '取消',
                type: 'warning',
                }).then(async () => {
                    this.activeData.children.forEach(it=>{
                        this.$parent.deleteProjectItemInfo(it)
                    })
                    this.activeData.__config__.layout = 'colFormItem'
                }).catch(() => {
                    this.activeData.enableFold = true
                });
            }
            if(val){
                this.activeData.__config__.layout = 'collapseFormItem'
