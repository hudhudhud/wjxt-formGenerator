        ...
        <el-row class="project-setting-container" type="flex" justify="center" align="top">
          ...
          <!--      <el-row type="flex" align="middle">
            ...
            <el-col :span="6" class="project-setting-view">
                ...
                <el-row type="flex" align="middle">
                    <el-col :span="12">
                        <p class="project-setting-label">是否需要登录</p>
                    </el-col>
                    <el-col :span="12">
                        <el-switch
                            @change="saveUserProjectSetting"
                            v-model="userProjectSettingData.needLogin"/>
                    </el-col>
                </el-row>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            getUploadUrl() {
                return `${process.env.VUE_APP_BASE_URL}/upload/file`
            },
            getUserInfo() {
        ...
        methods: {
                ...
                this.$api.get(`/user/project/setting/${this.projectKey}`).then(res => {
                    if (res.data) {
                        ...
                        let {
                            ...
                            timedQuantitativeQuantity, needLogin
                        ...
                        this.projectSetting = {
                            ...
                            timingCollectForm: !!timedCollectionBeginTime,
                            timingQuantitativeForm: !!timedQuantitativeQuantity,
                            needLogin: !!needLogin
                        }
                    }
                })
            ...
            saveUserProjectSetting() {
                this.userProjectSettingData.projectKey = this.projectKey
                this.$api.post('/user/project/settingSave', this.userProjectSettingData).then(res => {
                })
            },
